package com.jiaruiblog.api.intercepter;

import com.jiaruiblog.common.util.property.PropertiesUtil;
...
public class SensitiveWordInit {
    ...
    public static Set<String> getStrings(InputStream inputStream, Charset encode) {
        ...
        //敏感词库
        try (InputStreamReader read = new InputStreamReader(inputStream, encode)) {
